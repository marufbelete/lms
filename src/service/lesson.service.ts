...
static async editLesson(param:Partial<LessonCreationAttributes>,filter:UpdateOptions){
...
static async editLessonUser(param:Partial<Lesson_User>,filter:UpdateOptions){
